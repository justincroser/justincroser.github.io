...
#  Things you should do after installing Fedora 39
...
sudo dnf install ~[https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$\(rpm](https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$%28rpm)~ -E %fedora).noarch.rpm
sudo dnf install ~[https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$\(rpm](https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$%28rpm)~ -E %fedora).noarch.rpm
...
sudo dnf check-update sudo dnf update sudo dnf install package_name sudo dnf autoremove sudo dnf search package_name sudo dnf downgrade package_name